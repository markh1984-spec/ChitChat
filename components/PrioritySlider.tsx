...
export default function PrioritySlider({
  ...
  return (
    <div className="bg-accent-50 border border-accent-200 rounded-2xl p-6">
      <label htmlFor="priority-slider" className="block text-xl font-bold text-accent-900 mb-1">
        What matters more when finding people for you?
      </label>
      <p className="text-base text-accent-800/70 mb-4">
        This is a setting on your account — you can change it any time.
      </p>
      <div className="flex items-center gap-4">
        <span className="text-lg font-medium text-accent-800 w-32 shrink-0">📍 Location</span>
        <input
          id="priority-slider"
          type="range"
          min={0}
        ...
        />
        <span className="text-lg font-medium text-accent-800 w-40 shrink-0 text-right">
          Interests 🎯
        </span>
      </div>
      <p className="text-center text-lg font-semibold text-accent-700 mt-3" aria-live="polite">
